...
renderFormulaCards(document.getElementById("formulaLotesContainer"), window.FORMULAS_LOTES || [
    {id:"lotes_criacao",nome:"Lotes em criação",formula_exibicao:"Contagem dos lotes únicos recebidos nos últimos 45 dias, pela Data Recepcao",descricao:"Quantidade de lotes abertos únicos cuja Data Recepcao está dentro da janela móvel dos últimos 45 dias.",formula_dax:"lotes_em_criacao = DISTINCTCOUNT(base[Chave_Lote_Granja])"},
